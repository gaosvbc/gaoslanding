    ...
    <footer id="contacto" className="bg-[#050505] text-white pt-32 pb-12 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-7xl mx-auto flex flex-col min-h-[50vh] justify-between">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-neutral-800 mb-24">
          <a href="https://www.gaosstudio.es" className="group bg-[#050505] p-12 lg:p-24 flex flex-col justify-between aspect-square md:aspect-auto hover:bg-[#0a0a0a] transition-colors cursor-pointer">
          ...
          <a href="https://www.gaosreforma.es" className="group bg-[#050505] p-12 lg:p-24 flex flex-col justify-between aspect-square md:aspect-auto hover:bg-[#0a0a0a] transition-colors cursor-pointer">
